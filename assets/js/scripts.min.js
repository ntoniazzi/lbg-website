...
(() => {
    ...
    const senderName = form.querySelector('[name="_email.from"]');
        ...
        try {
            ...
            const response = await fetch(url, {
                ...
                body: JSON.stringify({
                    ...
                    '_email.from': form.elements.nom.value,
                    '_email.subject': '[lavalbournygym] Contact - Nouvel envoi'
                })
            });
